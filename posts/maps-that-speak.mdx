...
draft: false
description: 'A hackathon project to get floodplain map data delivered as speech and experienced while on the move. Now wondering if another type of data would make more sense for this type of approach?'
layout: PostSimple
...
This is a draft post. Another one is [here](/posts/innovative-use-cases-for-space-data-in-africa).
